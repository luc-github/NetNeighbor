---
title: NetNeighbor
description: Discover and monitor devices on your local network — free desktop application for Windows, Linux and macOS.
---
...
<CardGrid>
  ...
  <Card title="Icon packs" icon="seti:image">
    ...
    [Read CONTRIBUTING_ICONS →](https://github.com/luc-github/NetNeighbor/blob/main/docs/CONTRIBUTING_ICONS.md)
  </Card>
